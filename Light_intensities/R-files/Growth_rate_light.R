...
statistic_label2 <-
  glue::glue(
    "<b>B) </b>Kruskal-Wallis, <i>H</i>({res.aov2$df}) = {formatted_statistic}, <i>p</i> = {res.aov2$p}, <i>n</i> = {res.aov2$n}"
  )
...
label5 <- expression("I" [k] * " = 57 PFDs")
label6 <- expression("x"["y = 0"] * " = 9 PFDs")
