...
g4 <- PI_2D2_2 + PI_2D2_per_cell + plot_layout(guides = "collect", ncol = 1, axis_titles = "collect_x") &
...
g3 <- PI_2D2_per_cell2 + PI_4B1_per_cell + PI_4B9_per_cell + plot_layout(guides = "collect", ncol = 1, axis_titles = "collect") &
  theme(legend.position = "bottom",
        legend.box.margin = margin(-10, -10, -10, -10))
